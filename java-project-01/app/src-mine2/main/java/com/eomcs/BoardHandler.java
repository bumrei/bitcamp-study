...
public class BoardHandler /* = this */ implements Handler {
  ...
  String boardName;  // this. = boardHandler
  Scanner keyScan;  // this.
  ArrayList boardList = new ArrayList(); //ArrayList2 의 해결 방법  // this.
