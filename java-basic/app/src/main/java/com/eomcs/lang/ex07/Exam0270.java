...
public class Exam0270 {
  ...
  //  static void m1(String[] names, String[] emails) {} // 배열 파라미터는 여러개가 가능하다.
  //
  //    => 중간에 다른 타입이 온다 하더라도 안된다.
  //  static void m1(String... names, int a, String... emails) {}// 컴파일 오류!
  //  static void m1(String[] names, int[] emails) {} // OK!!!!!!!!!
  //
