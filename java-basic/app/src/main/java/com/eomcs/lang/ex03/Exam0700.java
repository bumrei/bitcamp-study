...
public class Exam0700 {
  public static void main(String[] args) {
    ...
    System.out.println("Hello,\rabc"); // 커서(cursor)를 처음으로 돌리는 문자 abclo -> abcdef 하면 hello가 완전 무칠까?
    // 커서란? 문자를 출력할 위치를 가리키는 것.

    System.out.println("Hello,\b\b\bworld!"); // 커서를 뒤로 한 칸 이동시키는 문자 HellWorld -> backspace 지우는것
    System.out.println("Hello,\tworld!"); // 탭 공간을 추가시키는 문자 즉 띄어쓰기 2칸
    System.out.println("Hello,\fworld!"); // 잘라내기(?)
